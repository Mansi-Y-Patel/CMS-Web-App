            ...
            <div class="py-6 px-4 mx-auto max-w-screen-xl sm:py-6 lg:px-6">
                <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Fees Pending</h3>
                    ...
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Review phase-2</h3>
                    ...
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Review phase-1</h3>
                    ...
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Placement Record</h3>
                    ...
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Scholarships</h3>
                    ...
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Academic Calendar</h3>
